# Day 0 Lab: LinkedIn Job Vetting & Scam Forensics
...
Your mission in this lab is to conduct a **forensic investigation** of an assigned or student-selected LinkedIn job posting and render a verified editorial verdict based on **three independent vectors of proof**.

---

## The 4-Vector Verification Protocol
...
* **Reverse Image Search:**
  - Right-click the recruiter's profile image -> search using **Google Lens**, **Yandex**, or **TinEye**.
  - Does the same photo appear on multiple different websites, stock photo libraries, or random profiles under different names?
...
* **Check the details:**
  ...
  - Who is the registered agent? Is the address a real commercial office or a vacant residential lot on Google Maps?
...
Standout investigations with rigorous chain-of-custody documentation will be selected for publication into the Community Investigation Logs via Pull Request.
