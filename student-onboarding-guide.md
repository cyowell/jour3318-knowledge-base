...
> For the first half of this course, you will do **100% of your work directly in your web browser**. No command lines, terminal commands, or complicated local installations required.
...
| :--- | :--- | :--- |
| **Course GitBook Hub** | The Course Hub | The authoritative reference manual. Access via your Canvas link to read forensic protocols and tool guides. |
| **Your Personal GitHub Repo** | Your Investigative Workbench | Your private digital reporter's notebook. Log evidence in `investigation-log.md` and track AI chats in `PROMPTS.md`. |
| **[Course Knowledge Base](https://github.com/cyowell/jour3318-knowledge-base)** | Community Archive | Where the class collaborates. You submit **Pull Requests** here to publish your approved discoveries. |
...
3. Choose a professional or investigative username (e.g., `austin-investigator-01` or `jdoe-jour`). This will appear on your published investigations.
...
2. Click the green **"Use this template"** button -> select **"Create a new repository"**.
...
You now have a personal investigative workspace with pre-formatted files:
...
4. **Submit Your Pull Request:**
   - At the top of your repository page, click the **"Pull requests"** tab -> click **"New pull request"**.
...
5. **Editorial Review & Merging:**
   ...
   - Once approved and merged, your work automatically updates the course GitBook with your name permanently credited in the Git commit history.
...
*Need assistance? Check the Course GitBook via your Canvas course link or consult the custom Course Gemini Gem for guided troubleshooting.*
