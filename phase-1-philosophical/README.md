...
- **Frankfurt's Epistemology:** Analyzing Harry Frankfurt’s *On Bullshit* to distinguish between lying (which conceals truth) and automated bullshit (which is indifferent to truth).
- **AI Authorship & Cognition:** Engaging with critical literature (e.g., *Your AI Use Is Breaking My Brain*, *Is AI really 'writing'?*) on meaning-making versus statistical token prediction.
- **Taxonomy of Information Disorder:** Deconstructing problematic information based on factual falsity and harmful intent:
  - *Misinformation:* Unintentional errors, misinterpretations, or misattributions.
  - *Disinformation:* Deliberately fabricated content engineered to deceive and harm.
  - *Mal-information:* Genuine, factual information weaponized out of context to cause harm.
- **Historical & Sociotechnical Deception:** Case studies of state-sponsored propaganda, astroturfing, and algorithmic echo chambers.
